...
npm package `react-native-chatty-cloud` privides ui components and api to develop chat ui. 

If you are experience react native using javascript or typescript, you can integrate and test to your exsiting app in several minutes
