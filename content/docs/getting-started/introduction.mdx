...
Developing chat service using socket is not easy. Not only frontend ui and flow but also backend socket should be developed. It spend several months and high development cost
